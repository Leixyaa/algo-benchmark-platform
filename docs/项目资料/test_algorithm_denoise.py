#!/usr/bin/env python3
"""
Minimal test algorithm for the controlled "algorithm access" workflow.
...
Example:
    python test_algorithm_denoise.py --input ./input --output ./output
    python test_algorithm_denoise.py --input ./input/demo.png --output ./output
"""
